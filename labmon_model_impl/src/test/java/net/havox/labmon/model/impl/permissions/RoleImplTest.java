...
/**
 * Implementation specific test for {@link RoleImpl}.
 *
 * @author Christian Otto
 */
public class RoleImplTest extends AbstractChangeAwareClassTest { // NOSONAR API test is only inherited, so only derived test cases.
    @Override
