...
import net.havox.labmon.model.utils.validation.employment.AbstractProjectValidationTest;
import net.havox.labmon.model.utils.validation.employment.ProjectImplValidator;
import net.havox.labmon.model.utils.validation.employment.ProjectValidator;

/**
 * Validation test for {@link ProjectImpl}.
 *
 * @author Christian Otto
 */
public class ProjectValidationTest extends AbstractProjectValidationTest { // NOSONAR Validation test is only inherited, so only derived test cases.
    @Override
    ...
    public ProjectValidator getProjectValidator() {
        return new ProjectImplValidator();
    }
}
